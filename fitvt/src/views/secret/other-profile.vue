        ...
        <div class="single-post" v-for="(post, index) in posts" :key="index">
          ...
          <div class="title_image">
            ...
            <div class="desc">
              ...
              <img
                ...
                @error="
                  $event.target.src =
                    'https://www.danone.com/content/dam/danone-corp/danone-com/stories/stay-strong-stay-safe-danone.jpg'
                "
              />
            </div>
          </div>
          ...
          <div class="icons">
            ...
            <form>
              ...
              />
              <button
                @click.prevent="submitComment(post.docId)"
...
export default {
  ...
  methods: {
    ...
    async savePost(post, num) {
      ...
      this.randomID =
        "a" +
        post.title.replace(/(?!\w|\s)./g, "").split(" ")[0] +
      ...
      swal("You saved workout!", "", "success");
    },
