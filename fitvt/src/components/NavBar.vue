<template>
  <nav id="nav">
    <div class="left" @click="toMainPage">
      <img src="@/assets/logo.png" alt="logo" />
      <p>FITvt</p>
    </div>
    <div class="right">
      <button class="btn neon-btn" @click="toLogin" v-if="routeIsLogin">
        <span></span>
        <span></span>
        <span></span>
        <span></span>
...
export default {
  computed: {
    //show the login button only in home ('/') page
    routeIsLogin() {
...
#nav {
 ...
 .neon-btn:hover {
	 ...
	 box-shadow: 0 0 20px #008cff, 0 0 30px #008cff, 0 0 40px #008cff, 0 0 50px #008cff;
	 color: #eee;
}
 .neon-btn span {
	 position: absolute;
